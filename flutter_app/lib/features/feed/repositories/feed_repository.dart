...
/// Feed repository – provides the sample content.
/// In a production app this would talk to Firestore.
class FeedRepository {
  FeedRepository._();
  static final FeedRepository instance = FeedRepository._();

  Future<List<Idea>> fetchFeed() async {
    // Simulates an async data source
    return List.from(_sampleFeed);
  }
}

final List<Idea> _sampleFeed = [
  const Idea(
    id: 1,
    category: 'Psychology',
